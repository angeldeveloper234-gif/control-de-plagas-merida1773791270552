...
const TechBotWidget = ({ botId, metadata, sessionId, supabaseUrl, supabaseKey }: TechBotWidgetProps) => {
    useEffect(() => {
        ...
        const initBot = () => {
            if (window.LexFlow) {
                console.log('TechBotWidget: Initializing bot...');
                window.LexFlow.init({
                    id: botId,
                    metadata,
                ...
                console.warn('TechBotWidget: window.LexFlow not ready yet.');
            }
        };
        ...
        if (!script) {
            ...
            script.async = true;
            script.onload = () => {
                console.log('TechBotWidget: Script loaded.');
                initBot();
            };
            script.onerror = (e) => console.error('TechBotWidget: Script failed to load.', e);
