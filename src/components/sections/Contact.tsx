                    ...
                    >
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            <div className="space-y-1">
                                <input
                                    {...register("name")}
                                    className="w-full bg-transparent border-b-2 border-zinc-800 py-4 text-white focus:outline-none focus:border-[#E07B2A] transition-colors placeholder:text-zinc-700 text-sm tracking-widest font-sans"
